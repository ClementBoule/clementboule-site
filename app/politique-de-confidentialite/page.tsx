      ...
      <section className="py-12 md:py-16 bg-cb-creme border-t-4 border-cb-encre">
        <div className="max-w-3xl mx-auto px-6 space-y-8">
          ...
          >
            ...
            <p className="text-base text-cb-encre-soft leading-relaxed mt-2">
          ...
          >
            ...
            <p className="text-base text-cb-encre-soft leading-relaxed mb-3">
              Le site collecte uniquement les données que vous fournissez volontairement via le formulaire de contact :
            </p>
            <ul className="list-disc list-inside space-y-1 ml-2 text-base text-cb-encre-soft leading-relaxed">
              <li>Nom et prénom</li>
              <li>Adresse email</li>
            ...
            <p className="text-base text-cb-encre-soft leading-relaxed mt-3">
