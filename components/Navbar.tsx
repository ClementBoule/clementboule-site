    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-5">
          ...
          {/* CTA secondaire — Trouver mon format (vers le quiz) */}
          <a
            href="/#quiz"
            className={scrolled
              ? 'inline-flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-full border border-white/20 text-white/80 hover:text-white hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-200'
              : 'inline-flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-full border border-[#1A2B4A]/15 text-[#1A2B4A]/80 hover:text-[#3D6DB8] hover:border-[#3D6DB8]/40 hover:-translate-y-0.5 transition-all duration-200'
            }
          >
      ...
      {menuOpen && (
        <div className="lg:hidden bg-[#0F1A2E]/98 backdrop-blur-md border-t border-white/5 px-6 py-4 flex flex-col gap-4">
          ...
          <a
            href="/#quiz"
            onClick={() => setMenuOpen(false)}
            className="inline-flex items-center justify-center gap-1.5 border border-white/20 text-white/80 font-semibold px-5 py-2.5 rounded-full text-sm hover:bg-white/10 transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7l-3 3m0 0l-3-3m3 3V8" />
            </svg>
