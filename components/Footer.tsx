      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="text-sm font-semibold text-white/70">ClÃ©ment BoulÃ©</p>
            <p className="text-xs text-white/30 mt-1">{t.footer.tagline}</p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-white/35">
            ...
            <a href="mailto:hello@clementboule.com" className="hover:text-white/60 transition-colors">
          ...
          <p className="text-xs text-white/25">
            Â© {new Date().getFullYear()} ClÃ©ment BoulÃ©
          </p>
        </div>
      </div>
    </footer>
