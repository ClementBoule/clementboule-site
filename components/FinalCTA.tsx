    ...
    <section className="py-20 md:py-28 bg-[#1A2B4A] relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          >
            {lang === 'fr' ? 'Me contacter directement' : 'Contact me directly'}
          ...
          <a
            href="/formations"
            className="inline-flex items-center gap-2 text-white/70 border border-white/20 font-semibold px-7 py-4 rounded-full hover:bg-white/10 hover:text-white hover:-translate-y-0.5 transition-all duration-200"
          >
            {lang === 'fr' ? 'Voir les formations' : 'Browse training programs'}
          </a>
        </div>
