                  ...
                  <ScrollReveal key={i} delay={140 + i * 60}>
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-transparent pointer-events-none rounded-2xl" />
                        {logo ? (
                          <img src={logo} alt="" className="w-full h-full object-contain relative z-10 p-1" onError={(e) => { const t = e.currentTarget; t.style.display='none'; const p = t.parentElement; if(p && !p.querySelector('.logo-placeholder')){ const d = document.createElement('div'); d.className='logo-placeholder'; d.style.cssText='width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:#f3f4f6;border:2px dashed #d1d5db;border-radius:8px;'; d.innerHTML='<span style=\'font-size:11px;color:#9ca3af;text-align:center;padding:4px\'>Logo à uploader</span>'; p.appendChild(d); } }} style={{ transform: `scale(${eduScale})`, transformOrigin: 'center center' }} />
                        ) : (
                          <svg className="w-6 h-6" style={{ color: color.accent }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l9-5-9-5-9 5 9 5z" />
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
                  ...
                  <ScrollReveal key={i} delay={140 + i * 60}>
                    ...
                    >
                      ...
                      >
                        <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-transparent pointer-events-none rounded-2xl" />
                        {logo ? (
                          <img src={logo} alt="" className="w-full h-full object-contain relative z-10 p-1" onError={(e) => { const t=e.currentTarget; t.style.display='none'; const p=t.parentElement; if(p&&!p.querySelector('.lph')){const d=document.createElement('div');d.className='lph';d.style.cssText='width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:#f3f4f6;border:2px dashed #d1d5db;border-radius:8px;font-size:11px;color:#9ca3af;';d.textContent='Logo à uploader';p.appendChild(d);}}} style={{ transform: `scale(${eduScale})`, transformOrigin: 'center center' }} />
                        ) : (
                          <svg className="w-6 h-6" style={{ color: color.accent }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l9-5-9-5-9 5 9 5z" />
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" />
